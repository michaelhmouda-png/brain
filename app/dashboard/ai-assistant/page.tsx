  ...
  return (
    <div className="grid min-h-[50dvh] place-items-center">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-xl font-semibold text-slate-950">Opening Brain…</h1>
        <p className="mt-2 text-sm text-slate-500">Brain now stays with you across the entire operation.</p>
      </div>
    </div>
  );
}
