  ...
  en: {
    ...
    navigation: {
      ...
      destinations: {
        ...
        recurringRoutines: { label: 'Recurring routines', description: 'Shift-aware operational automation', keywords: 'recurring tasks routines schedule automation' },
    ...
    schedule: {
      ...
      createShift: 'Create shift', createShiftTitle: 'Create a concrete shift',
      createShiftDescription: 'Schedule an active employee at an active location.',
      location: 'Location', date: 'Date', startTime: 'Start time', endTime: 'End time',
      timezone: 'Location timezone', overnight: 'Ends the following local day',
      create: 'Create shift', creating: 'Creating…', cancel: 'Cancel',
      concreteShifts: 'Concrete shifts', shiftCreated: 'Shift created.',
      inputInvalid: 'Review the employee, location, date, and times.',
      employeeInvalid: 'Choose an active employee in your company.',
      locationInvalid: 'Choose an active location in your company.',
  ...
  ar: {
    ...
    navigation: {
      ...
      destinations: {
        ...
        recurringRoutines: { label: 'الروتينات المتكررة', description: 'أتمتة تشغيلية مرتبطة بالورديات', keywords: 'مهام متكررة روتين جدول أتمتة' },
    ...
    schedule: {
      ...
      createShift: 'إنشاء وردية', createShiftTitle: 'إنشاء وردية فعلية',
      createShiftDescription: 'جدولة موظف نشط في موقع نشط.',
      location: 'الموقع', date: 'التاريخ', startTime: 'وقت البدء', endTime: 'وقت الانتهاء',
      timezone: 'المنطقة الزمنية للموقع', overnight: 'تنتهي في اليوم المحلي التالي',
      create: 'إنشاء الوردية', creating: 'جارٍ الإنشاء…', cancel: 'إلغاء',
      concreteShifts: 'الورديات الفعلية', shiftCreated: 'تم إنشاء الوردية.',
      inputInvalid: 'راجع الموظف والموقع والتاريخ والأوقات.',
      employeeInvalid: 'اختر موظفًا نشطًا في شركتك.',
      locationInvalid: 'اختر موقعًا نشطًا في شركتك.',
